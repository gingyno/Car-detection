...
model.predict(source="CarVideo.mp4", save=True, imgsz=320, conf=0.5)

# Configure the tracking parameters and run the tracker
model = YOLO('yolov8n.pt')

results = model.track(source="CarVideo.mp4",conf=0.3, iou=0.5, save=True, tracker="bytetrack.yaml")
...
video_info = sv.VideoInfo.from_video_path("CarVideo.mp4")
